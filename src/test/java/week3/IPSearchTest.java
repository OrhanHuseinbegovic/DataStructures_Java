...
public class IPSearchTest {
    ...
    public static String filePath = "C:\\Users\\ohuse\\IdeaProjects\\DataStructures\\src\\main\\java\\week3\\labTask\\IP2LOCATION.csv";
    ...
    @Test
    public void testValidIps() throws FileNotFoundException {
    ...
    @Test
    public void testInvalidIps() throws FileNotFoundException {
        assertEquals(ipAddresses.length, 4637053);
        assertNotNull(ipAddresses[0]);
        assertNotNull(ipAddresses[4637052]);
